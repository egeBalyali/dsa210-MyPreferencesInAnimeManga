...
html_file_path = 'Dekusdad\'s Manga List - MyAnimeList.net.html'
output_text_path = 'data/EgeMangaInfo.txt'
output_json_path = 'data/EgeMangaJSON.json'
...
for entry in entries:
    ...
    show_name = entry.find('td', class_='data title').find('a', class_='link sort').text.strip()
    ...
    progress_td = entry.find('td', class_='data chapter')
